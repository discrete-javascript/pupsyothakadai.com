                ...
                <header class="page-heading clearfix">
                    ...
                    <div class="breadcrumbs pull-right">
                        <ul class="breadcrumbs-list">
                            ...
                            <li class="current">Question and Answer Entry </li>
                        </ul>
                    </div><!--//breadcrumbs-->
                </header> 
                <div class="page-content">
                    <div class="row">
                        <article class="contact-form col-md-8 col-sm-7  page-row">                            
                            <h3 class="title">Question and Answer Entry Screen</h3>
                            <p>Please Enter Question and answers and chooses correct answer with Y</p>
...
<?php 
$sql ="SELECT * FROM school_info where status='1' ";                                
...
<?php
$sql ="SELECT * FROM subject_info where status='1'";  
$result = $mysqli->query($sql);
if ($result->num_rows > 0) {
while($row=$result->fetch_assoc())
{
