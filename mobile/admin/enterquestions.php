...
?>
                                                                    ...
                                                                    <div class="form-group name"><label for="class">Class</label>
                                                                    <?php
...
$sql=mysqli_query($conn,"SELECT * FROM class_info");
?>
...
while($row=$result->fetch_assoc())
{
$pk_classid=$row['pk_classid'];
$classname=$row['classname'];
?>

<option value="<?php echo $pk_classid; ?>"> <?php echo $classname; ?> </option>
<?php
}
}
else
...
?>
                                                                    ...
                                                                    <div class="form-group name"><label for="chapter">Chapter</label>
<?php
                                                                    $sql=mysqli_query($conn,"SELECT * FROM chapter_info");
?>

<select name="chapterdetail" class="form-control">    
<?php
$sql ="SELECT * FROM chapter_info";  
$result = $mysqli->query($sql);
if ($result->num_rows > 0) {
while($row=$result->fetch_assoc())
{
$pk_chapterid=$row['pk_chapterid'];
$chapterdetail=$row['chapterdetail'];
?>

<option value="<?php echo $pk_chapterid; ?>"> <?php echo $chapterdetail; ?> </option>
<?php
}
}
else
