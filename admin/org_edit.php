...
$('#organization_edit_frm').submit(function(e) {
    var pk_SchoolId_f =0;
    var SchoolName_f =0;
        ...
        <div class="content container">
            <div class="page-wrapper">
                <header class="page-heading clearfix">
                    <h1 class="heading-title pull-left">Manage Organisation Details</h1>
                    <div class="breadcrumbs pull-right">
                        <ul class="breadcrumbs-list">
                            <li class="breadcrumbs-label">You are here:</li>
                            <li><a href="index.php">Home</a><i class="fa fa-angle-right"></i></li>
                            <li class="current">Manage Organisation Details</li>
                        </ul>
                    </div><!--//breadcrumbs-->
                </header> 
                <div class="page-content">
                    ...
                    {
                    $school_info_qry="select * from school_info where pk_SchoolId=".$_GET['pk_SchoolId'];
                    ...
                    while($r=mysqli_fetch_array($val))
                    {
                        ...
                        $lastupdateed=$r['lastupdateed'];
                        $status=$r['status'];
                    }}
                    ?>
                            <form id="organization_edit_frm"  method="POST">
							                                <div class="form-group name">
                                    <label for="name">pk_SchoolId </label>
                                    <input name="pk_SchoolId" type="text" id="pk_SchoolId"  class="form-control" placeholder="Enter pk_SchoolId" value="<?php  echo $pk_SchoolId; ?>">
                                </div>
								                                <div class="form-group name">
                                    <label for="name">SchoolName </label>
                                    <input name="SchoolName" type="text" id="SchoolName" class="form-control" placeholder="Enter SchoolName"  value="<?php  echo $SchoolName; ?>">
                                </div>
								                                <div class="form-group name">
                                    <label for="name">PrincipalName </label>
                                    <input name="PrincipalName" id="PrincipalName" type="text" class="form-control" placeholder="PrincipalName"  value="<?php  echo $PrincipalName; ?>">
                                </div>
				<div class="form-group name">
                                    <label for="name">SchoolAddress </label>
                                    <input name="SchoolAddress"  id="SchoolAddress"  type="text" class="form-control" placeholder="Enter SchoolAddress"  value="<?php  echo $SchoolAddress; ?>">
                                </div>
				<div class="form-group name">
                                    <label for="name">City </label>
                                    <input name="City" id="City" type="text" class="form-control" placeholder="Enter City" value="<?php  echo $City; ?>">
                                </div>
				<div class="form-group name">
                                    <label for="name">State</label>
                                    <input name="State" id="State" type="text" class="form-control" placeholder="Enter State"  value="<?php  echo $State; ?>">
                                </div>
				<div class="form-group name">
                                    <label for="name">Country </label>
                                    <input name="Country"  id="Country"  type="text" class="form-control" placeholder="Enter Country"  value="<?php  echo $Country; ?>">
                                </div>
								                                <div class="form-group name">
                                    <label for="name">Pincode </label>
                                    <input name="Pincode"  id="Pincode" type="text" class="form-control" placeholder="Pincode"  value="<?php  echo $Pincode; ?>">
                                </div>
								                                <div class="form-group name">
                                    ...
                                    <input name="Website"  id="Website"type="text" class="form-control" placeholder="Website"  value="<?php  echo $Website; ?>">
                                </div>

                                <div class="form-group name">
                                    <label for="name">ContactNo </label>
                                    <input name="ContactNo"  id="ContactNo" type="text" class="form-control" placeholder="ContactNo"  value="<?php  echo $ContactNo; ?>">
                                </div>
								
								<div class="form-group name">
                                    <label for="name">createdby </label>
                                    <input name="createdby" id="createdby"  type="text" class="form-control" placeholder="createdby"  value="<?php  echo $createdby; ?>">
                                </div>
								                                <div class="form-group name">
                                    <label for="name">lastupdatedby </label>
                                    <input name="lastupdatedby"  id="lastupdatedby"  type="text" class="form-control" placeholder="lastupdatedby"  value="<?php  echo $lastupdatedby; ?>">
                                </div>

                                <div class="form-group name">
                                    <label for="name">lastupdateed</label>
                                    <input name="lastupdateed"  id="lastupdateed" type="text" class="form-control" placeholder="lastupdateed"  value="<?php  echo $lastupdateed; ?>">
                                </div>
								
								                                <div class="form-group name">
                                    <label for="name">status</label>
                                    <input name="status"  id="status"  type="text" class="form-control" placeholder="status"  value="<?php  echo $status; ?>">
                                </div>
      ...
      <tr>
        ...
        <tbody>
                    ...
                    ?>
                        ...
                        <td><form method="post" action="org_edit.php"><button type="submit" class="btn btn-theme" >Edit</button></form>&nbsp;&nbsp;<form  method="post" action="org_delete.php"><button type="submit" class="btn btn-theme" >Delete</button></form></td>
                         </tr>
                <?php       
                    }		
                ?>
